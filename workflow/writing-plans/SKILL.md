...
- Dispatch parallel agents for independent tasks (no shared state, no sequential dependencies)
- Best for plans with multiple independent subsystems or parallelizable work streams
